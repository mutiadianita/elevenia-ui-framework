      ...
      <aside>
        <Accordion label="UTILITIES" className="u-pl-32">
          <ul>
            ...
            {/* <li><NavLink to="/boxshape" activeClassName="active">Box Shape</NavLink></li> */}
            ...
            <li><NavLink to="/overlay" activeClassName="active">Overlay</NavLink></li>
            <li><NavLink to="/position" activeClassName="active">Position</NavLink></li>
            {/* <li><NavLink to="/structure" activeClassName="active">Structure</NavLink></li> */}
        ...
        <Accordion label="MOLECULES" className="u-pl-32">
          <ul>
            <li><NavLink to="/ribbon" activeClassName="active">Ribbon</NavLink></li>
          </ul>
        </Accordion>
